...
export default function FaqPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "The score is calculated mathematically via fixed weights: Positioning (20%), Messaging (15%), Website & UX (15%), Conversion Triggers (15%), Trust (10%), Defensibility (10%), and Growth Foundation (15%). It is not an arbitrary number generated by an LLM prompt.",
    },
    {
